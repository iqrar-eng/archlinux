return {
    ...
    config = function()
      ...
      vim.keymap.set({ "n", "x" }, "<C-S-E>", function() mc.lineAddCursor(-1) end, { desc = "MC: cursor above" })
      ...
      vim.keymap.set({ "n", "x" }, "<M-E>", function() mc.lineSkipCursor(1) end, { desc = "MC: skip below" })
      vim.keymap.set({ "n", "x" }, "<M-L>", function() mc.lineSkipCursor(-1) end, { desc = "MC: skip above" })
      ...
      mc.addKeymapLayer(function(layerSet)
        ...
        layerSet("x", "<C-S-F>", function() mc.transposeCursors(1) end, { desc = "MC: transpose forward", buffer = true })
        layerSet("x", "<C-S-A>", function() mc.transposeCursors(-2) end, { desc = "MC: transpose backward", buffer = true })
        layerSet("x", "<M-C-H>", function() mc.swapCursors(1) end, { desc = "MC: swap forward", buffer = true })
        layerSet("x", "<M-C-E>", function() mc.swapCursors(-1) end, { desc = "MC: swap backward", buffer = true })
        ...
        layerSet({ "n", "x" }, "<C-H>", function() for _ = 1, vim.v.count1 do mc.nextCursor() end end, { desc = "MC: next cursor", buffer = true })
        layerSet({ "n", "x" }, "<C-S>", function() for _ = 1, vim.v.count1 do mc.prevCursor() end end, { desc = "MC: prev cursor", buffer = true })
        layerSet({ "n", "x" }, "<C-S-H>", mc.lastCursor, { desc = "MC: last cursor", buffer = true })
        layerSet({ "n", "x" }, "<C-S-S>", mc.firstCursor, { desc = "MC: first cursor", buffer = true })
        ...
        layerSet({ "n", "x" }, "<C-^>", function() for _ = 1, vim.v.count1 do mc.deleteCursor() end end, { desc = "MC: delete cursor", buffer = true })
